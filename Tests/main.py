...
#TODO: I MOVE THIS FILE TO A DIFFERENT FOLDER - USE ../ TO GET OUT OF THIS FOLDER OT ./<FOLDER> TO NAVIGATE INTO A SPEDIFIC FOLFER
#SO FOR EXAMPLE - NOW INSTEAD OF "make_schedule" YOU NEED TO DO ../BACKEND/make_schedule
def main():
